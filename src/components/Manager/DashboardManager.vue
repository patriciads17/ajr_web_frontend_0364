<template>
    <div>
        <v-navigation-drawer class="indigo accent-1" v-model="drawer" :mini-variant.sync="mini" app permanent>
  ...
  export default {
    ...
    data () {
        return {
            ...
            drawer: true,
            items: [
            { title: 'My Account', icon: 'mdi-account', to: '/myProfileManager' },
            { title: 'Data Shift', icon: 'mdi-calendar-clock', to: '/tableShift' },
            { title: 'Data Promo', icon: 'mdi-ticket-percent', to: '/tablePromo' },
            ],
            mini: true,
